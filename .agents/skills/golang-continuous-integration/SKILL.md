...
description: 'Fornece configuração de pipeline CI/CD usando GitHub Actions para projetos Golang. Abrange testes, linting, SAST, verificação de segurança, cobertura de código, Dependabot, Renovate, GoReleaser, automação de revisão de código e pipelines de lançamento. Use esta ferramenta sempre que configurar CI para um projeto Go, configurar fluxos de trabalho, adicionar linters ou verificadores de segurança, configurar Dependabot ou Renovate, automatizar lançamentos ou aprimorar um pipeline CI existente. Também é útil quando o usuário deseja adicionar critérios de qualidade ao seu projeto Go.'
---

Fornece configuração de pipeline CI/CD usando GitHub Actions para projetos Golang. Abrange testes, linting, SAST, verificação de segurança, cobertura de código, Dependabot, Renovate, GoReleaser, automação de revisão de código e pipelines de lançamento. Use esta ferramenta sempre que configurar CI para um projeto Go, configurar fluxos de trabalho, adicionar linters ou verificadores de segurança, configurar Dependabot ou Renovate, automatizar lançamentos ou aprimorar um pipeline CI existente. Também é útil quando o usuário deseja adicionar critérios de qualidade ao seu projeto Go.
