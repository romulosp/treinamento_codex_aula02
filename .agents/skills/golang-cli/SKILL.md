---
name: golang-cli
description: 'Desenvolvimento de aplicações CLI em Golang. Use ao construir, modificar ou revisar uma ferramenta CLI em Go — especialmente para estrutura de comandos, tratamento de flags, camadas de configuração, incorporação de versões, códigos de saída, padrões de E/S, tratamento de sinais, autocompletar do shell, validação de argumentos e testes unitários da CLI. Também é acionado quando o código usa cobra, viper ou urfave/cli.'
---

Desenvolvimento de aplicações CLI em Golang. Use ao construir, modificar ou revisar uma ferramenta CLI em Go — especialmente para estrutura de comandos, tratamento de flags, camadas de configuração, incorporação de versões, códigos de saída, padrões de E/S, tratamento de sinais, autocompletar do shell, validação de argumentos e testes unitários da CLI. Também é acionado quando o código usa cobra, viper ou urfave/cli.
