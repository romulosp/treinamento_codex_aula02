...
description: 'Guia completo para acesso a bancos de dados em Go. Abrange consultas parametrizadas, varredura de structs, tratamento de colunas nulas, padrões de erro, transações, níveis de isolamento, SELECT FOR UPDATE, pool de conexões, processamento em lote, propagação de contexto e ferramentas de migração. Use esta habilidade sempre que escrever, revisar ou depurar código Golang que interage com PostgreSQL, MariaDB, MySQL ou SQLite. Também é útil para testes de banco de dados ou qualquer dúvida sobre database/sql, sqlx, pgx ou consultas SQL em Golang. Esta habilidade NÃO gera esquemas de banco de dados ou SQL de migração.'
---

Guia completo para acesso a bancos de dados em Go. Abrange consultas parametrizadas, varredura de structs, tratamento de colunas nulas, padrões de erro, transações, níveis de isolamento, SELECT FOR UPDATE, pool de conexões, processamento em lote, propagação de contexto e ferramentas de migração. Use esta habilidade sempre que escrever, revisar ou depurar código Golang que interage com PostgreSQL, MariaDB, MySQL ou SQLite. Também é útil para testes de banco de dados ou qualquer dúvida sobre database/sql, sqlx, pgx ou consultas SQL em Golang. Esta habilidade NÃO gera esquemas de banco de dados ou SQL de migração.
