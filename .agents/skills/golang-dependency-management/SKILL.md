...
description: 'Fornece estratégias de gerenciamento de dependências para projetos Golang, incluindo gerenciamento de go.mod, instalação/atualização de pacotes, versionamento semântico, Seleção de Versão Mínima (MVS), verificação de vulnerabilidades, rastreamento de dependências desatualizadas, análise do tamanho das dependências, atualizações automatizadas com Dependabot/Renovate, resolução de conflitos e visualização do gráfico de dependências. Use esta habilidade sempre que adicionar, remover, atualizar ou auditar dependências do Go, resolver conflitos de versão, configurar atualizações automatizadas de dependências, analisar o tamanho de binários ou trabalhar com espaços de trabalho go.work.'
---

Fornece estratégias de gerenciamento de dependências para projetos Golang, incluindo gerenciamento de go.mod, instalação/atualização de pacotes, versionamento semântico, Seleção de Versão Mínima (MVS), verificação de vulnerabilidades, rastreamento de dependências desatualizadas, análise do tamanho das dependências, atualizações automatizadas com Dependabot/Renovate, resolução de conflitos e visualização do gráfico de dependências. Use esta habilidade sempre que adicionar, remover, atualizar ou auditar dependências do Go, resolver conflitos de versão, configurar atualizações automatizadas de dependências, analisar o tamanho de binários ou trabalhar com espaços de trabalho go.work.
