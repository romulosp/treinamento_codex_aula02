---
name: golang-linter
description: 'Fornece as melhores práticas de linting e configuração do golangci-lint para projetos Go. Abrange a execução de linters, a configuração do arquivo .golangci.yml, a supressão de avisos com diretivas nolint, a interpretação da saída do lint e o gerenciamento das configurações do linter. Use esta skill sempre que o usuário executar linters, configurar o golangci-lint, perguntar sobre avisos ou supressões de lint, configurar ferramentas de qualidade de código ou perguntar quais linters habilitar para um projeto Go. Use também quando o usuário mencionar golangci-lint, go vet, staticcheck, revive ou qualquer ferramenta de linting para Go.'
---

Fornece as melhores práticas de linting e configuração do golangci-lint para projetos Go. Abrange a execução de linters, a configuração do arquivo .golangci.yml, a supressão de avisos com diretivas nolint, a interpretação da saída do lint e o gerenciamento das configurações do linter. Use esta skill sempre que o usuário executar linters, configurar o golangci-lint, perguntar sobre avisos ou supressões de lint, configurar ferramentas de qualidade de código ou perguntar quais linters habilitar para um projeto Go. Use também quando o usuário mencionar golangci-lint, go vet, staticcheck, revive ou qualquer ferramenta de linting para Go.
