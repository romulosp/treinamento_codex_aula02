...
description: 'Modernize continuamente o código Go para usar os recursos mais recentes da linguagem, melhorias na biblioteca padrão e padrões idiomáticos. Use esta habilidade sempre que escrever, revisar ou refatorar código Go para garantir que ele aproveite os padrões idiomáticos modernos do Go. Use também quando o usuário perguntar sobre atualizações, migração, modernização ou depreciação do Go, ou quando o linter de modernização relatar problemas. Abrange também a modernização de ferramentas: linters, SAST, revisão de código com IA em CI e práticas de desenvolvimento modernas. Acione esta habilidade proativamente quando notar padrões Go antigos que possuem substitutos modernos.'
---

Modernize continuamente o código Go para usar os recursos mais recentes da linguagem, melhorias na biblioteca padrão e padrões idiomáticos. Use esta habilidade sempre que escrever, revisar ou refatorar código Go para garantir que ele aproveite os padrões idiomáticos modernos do Go. Use também quando o usuário perguntar sobre atualizações, migração, modernização ou depreciação do Go, ou quando o linter de modernização relatar problemas. Abrange também a modernização de ferramentas: linters, SAST, revisão de código com IA em CI e práticas de desenvolvimento modernas. Acione esta habilidade proativamente quando notar padrões Go antigos que possuem substitutos modernos.
