...
description: 'Fornece recursos para se manter atualizado sobre notícias, comunidades e pessoas do Golang. Use quando estiver buscando recursos de aprendizado de Go, descobrindo novas bibliotecas, encontrando canais da comunidade ou acompanhando as mudanças e lançamentos da linguagem Go.'
---

Fornece recursos para se manter atualizado sobre notícias, comunidades e pessoas do Golang. Use quando estiver buscando recursos de aprendizado de Go, descobrindo novas bibliotecas, encontrando canais da comunidade ou acompanhando as mudanças e lançamentos da linguagem Go.
