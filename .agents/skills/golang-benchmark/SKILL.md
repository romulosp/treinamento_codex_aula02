...
description: 'Benchmarking, criação de perfis e medição de desempenho em Go. Use ao escrever, executar ou comparar benchmarks em Go, criar perfis de caminhos críticos com pprof, interpretar perfis de CPU/memória/rastreamento, analisar resultados com benchstat, configurar a detecção de regressão de benchmarks em CI ou investigar o desempenho em produção com métricas de tempo de execução do Prometheus. Use também quando o desenvolvedor precisar de uma análise aprofundada de um indicador de desempenho específico — esta skill fornece a metodologia de medição, enquanto golang-performance fornece os padrões de otimização.'
---

Benchmarking, criação de perfis e medição de desempenho em Go. Use ao escrever, executar ou comparar benchmarks em Go, criar perfis de caminhos críticos com pprof, interpretar perfis de CPU/memória/rastreamento, analisar resultados com benchstat, configurar a detecção de regressão de benchmarks em CI ou investigar o desempenho em produção com métricas de tempo de execução do Prometheus. Use também quando o desenvolvedor precisar de uma análise aprofundada de um indicador de desempenho específico — esta skill fornece a metodologia de medição, enquanto golang-performance fornece os padrões de otimização.
