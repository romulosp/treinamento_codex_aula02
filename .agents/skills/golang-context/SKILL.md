---
name: golang-context
description: 'Uso idiomático de `context.Context` em Go — criação, propagação, cancelamento, tempos limite, prazos, valores de contexto e rastreamento entre serviços. Aplique ao trabalhar com `context.Context` em qualquer código Go.'
---

Uso idiomático de `context.Context` em Go — criação, propagação, cancelamento, tempos limite, prazos, valores de contexto e rastreamento entre serviços. Aplique ao trabalhar com `context.Context` em qualquer código Go.
