...
description: 'Recomenda bibliotecas e frameworks Golang prontos para produção. Aplica-se quando o usuário solicita sugestões de bibliotecas, deseja comparar alternativas ou precisa escolher uma biblioteca para uma tarefa específica. Também se aplica quando o agente de IA está prestes a adicionar uma nova dependência — garante que bibliotecas verificadas e prontas para produção sejam escolhidas.'
---

Recomenda bibliotecas e frameworks Golang prontos para produção. Aplica-se quando o usuário solicita sugestões de bibliotecas, deseja comparar alternativas ou precisa escolher uma biblioteca para uma tarefa específica. Também se aplica quando o agente de IA está prestes a adicionar uma nova dependência — garante que bibliotecas verificadas e prontas para produção sejam escolhidas.
