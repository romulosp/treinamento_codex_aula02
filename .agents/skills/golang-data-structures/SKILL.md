...
description: 'Estruturas de dados em Go — slices (funcionamento interno, crescimento de capacidade, pré-alocação, pacote slices), mapas (funcionamento interno, buckets hash, pacote maps), arrays, container/list/heap/ring, strings.Builder vs bytes.Buffer, coleções genéricas, ponteiros (unsafe.Pointer, weak.Pointer) e semântica de cópia. Use ao escolher ou otimizar estruturas de dados em Go, implementar contêineres genéricos, usar container/pacotes, ponteiros inseguros ou fracos, ou questionar o funcionamento interno de slices/maps.'
---

Estruturas de dados em Go — slices (funcionamento interno, crescimento de capacidade, pré-alocação, pacote slices), mapas (funcionamento interno, buckets hash, pacote maps), arrays, container/list/heap/ring, strings.Builder vs bytes.Buffer, coleções genéricas, ponteiros (unsafe.Pointer, weak.Pointer) e semântica de cópia. Use ao escolher ou otimizar estruturas de dados em Go, implementar contêineres genéricos, usar container/pacotes, ponteiros inseguros ou fracos, ou questionar o funcionamento interno de slices/maps.
