---
name: golang-testing
description: 'Este guia completo ensina como escrever testes em Go prontos para produção. Abrange testes orientados a tabelas, suítes de testes com testify, mocks, testes unitários, testes de integração, benchmarks, cobertura de código, testes paralelos, fuzzing, fixtures, detecção de vazamento de goroutines com goleak, testes de snapshot, vazamentos de memória, CI com GitHub Actions e convenções de nomenclatura idiomáticas. Use-o sempre que escrever testes, perguntar sobre padrões de teste ou configurar CI para projetos Go. Essencial para QUALQUER conversa relacionada a testes em Go.'
---

Este guia completo ensina como escrever testes em Go prontos para produção. Abrange testes orientados a tabelas, suítes de testes com testify, mocks, testes unitários, testes de integração, benchmarks, cobertura de código, testes paralelos, fuzzing, fixtures, detecção de vazamento de goroutines com goleak, testes de snapshot, vazamentos de memória, CI com GitHub Actions e convenções de nomenclatura idiomáticas. Use-o sempre que escrever testes, perguntar sobre padrões de teste ou configurar CI para projetos Go. Essencial para QUALQUER conversa relacionada a testes em Go.
