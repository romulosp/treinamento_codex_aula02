...
description: 'Estilo, formatação e convenções de código Golang. Use ao escrever código, revisar o estilo, configurar linters, escrever comentários ou estabelecer padrões de projeto.'
---

Estilo, formatação e convenções de código Golang. Use ao escrever código, revisar o estilo, configurar linters, escrever comentários ou estabelecer padrões de projeto.
