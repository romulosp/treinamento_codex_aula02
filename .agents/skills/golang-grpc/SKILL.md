---
name: golang-grpc
description: 'Fornece diretrizes de uso do gRPC, organização do protobuf e padrões prontos para produção para microsserviços em Golang. Use ao implementar, revisar ou depurar servidores/clientes gRPC, escrever arquivos proto, configurar interceptadores, lidar com erros do gRPC com códigos de status, configurar TLS/mTLS, realizar testes com bufconn ou trabalhar com RPCs de streaming.'
---

Fornece diretrizes de uso do gRPC, organização do protobuf e padrões prontos para produção para microsserviços em Golang. Use ao implementar, revisar ou depurar servidores/clientes gRPC, escrever arquivos proto, configurar interceptadores, lidar com erros do gRPC com códigos de status, configurar TLS/mTLS, realizar testes com bufconn ou trabalhar com RPCs de streaming.
