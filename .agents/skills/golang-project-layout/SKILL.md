...
description: 'Este guia auxilia na configuração de layouts e espaços de trabalho para projetos Go. Utilize-o sempre que iniciar um novo projeto Go, organizar um código-fonte existente, configurar um monorepo com múltiplos pacotes, criar ferramentas de linha de comando com múltiplos pacotes principais ou definir a estrutura de diretórios. Aplique-o também em qualquer inicialização ou reestruturação de projetos Go.'
---

Este guia auxilia na configuração de layouts e espaços de trabalho para projetos Go. Utilize-o sempre que iniciar um novo projeto Go, organizar um código-fonte existente, configurar um monorepo com múltiplos pacotes, criar ferramentas de linha de comando com múltiplos pacotes principais ou definir a estrutura de diretórios. Aplique-o também em qualquer inicialização ou reestruturação de projetos Go.
