...
description: 'Padrões e metodologia de otimização de desempenho em Go - se o gargalo for X, aplique Y. Abrange redução de alocação, eficiência da CPU, layout de memória, ajuste do coletor de lixo (GC), pooling, cache e otimização de caminhos críticos. Use quando o profiling ou benchmarks identificarem um gargalo e você precisar do padrão de otimização correto para corrigi-lo. Use também ao realizar revisões de código de desempenho para sugerir melhorias ou benchmarks que possam ajudar a identificar ganhos rápidos de desempenho. Não se destina a metodologia de medição (consulte a habilidade golang-benchmark) ou fluxo de trabalho de depuração (consulte a habilidade golang-troubleshooting).'
---

Padrões e metodologia de otimização de desempenho em Go - se o gargalo for X, aplique Y. Abrange redução de alocação, eficiência da CPU, layout de memória, ajuste do coletor de lixo (GC), pooling, cache e otimização de caminhos críticos. Use quando o profiling ou benchmarks identificarem um gargalo e você precisar do padrão de otimização correto para corrigi-lo. Use também ao realizar revisões de código de desempenho para sugerir melhorias ou benchmarks que possam ajudar a identificar ganhos rápidos de desempenho. Não se destina a metodologia de medição (consulte a habilidade golang-benchmark) ou fluxo de trabalho de depuração (consulte a habilidade golang-troubleshooting).
