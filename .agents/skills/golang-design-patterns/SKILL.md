...
description: 'Padrões de projeto idiomáticos em Go — opções funcionais, construtores, fluxo e propagação de erros, gerenciamento e ciclo de vida de recursos, desligamento elegante, resiliência, arquitetura, injeção de dependência, manipulação de dados e streaming. Aplique-os ao projetar APIs em Go, estruturar aplicações, escolher entre padrões, tomar decisões de projeto, fazer escolhas arquitetônicas ou reforçar a segurança em produção.'
---

Padrões de projeto idiomáticos em Go — opções funcionais, construtores, fluxo e propagação de erros, gerenciamento e ciclo de vida de recursos, desligamento elegante, resiliência, arquitetura, injeção de dependência, manipulação de dados e streaming. Aplique-os ao projetar APIs em Go, estruturar aplicações, escolher entre padrões, tomar decisões de projeto, fazer escolhas arquitetônicas ou reforçar a segurança em produção.
