 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class EFLNumericDocument implements EFLDocument {
     ...
     * @param length
     */
    public EFLNumericDocument(int fixedLength) {
        this();
     ...
     * @param length
     */
    public EFLNumericDocument(int minLength, int maxLength) {
        this();
