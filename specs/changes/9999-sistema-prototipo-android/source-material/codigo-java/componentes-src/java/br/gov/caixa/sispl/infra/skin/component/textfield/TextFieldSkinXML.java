 ...
 */
package br.gov.caixa.sispl.infra.skin.component.textfield;
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class TextFieldSkinXML extends ComponentSkinXML {
     ...
     * @param states
     */
    public TextFieldSkinXML() {

        //Define o nome do componente
        setName(ComponentSkin.TEXT_FIELD);
    }
