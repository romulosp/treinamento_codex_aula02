...
- Quando Sonar ou cobertura não estiverem configurados no módulo, a validação executa Auditoria de Qualidade Assistida por LLM com comandos e evidências registradas; ela não inventa resultado de Sonar ou percentual de cobertura.
